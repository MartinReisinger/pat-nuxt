...
- Create a component library using [`app/components/`](/dag_content/docs/4.x/directory-structure/app/components) directory
- Create utility and composable library using [`app/composables/`](/dag_content/docs/4.x/directory-structure/app/composables) and [`app/utils/`](/dag_content/docs/4.x/directory-structure/app/utils) directories
...
In addition, you can extend from a layer by adding the [extends](/dag_content/docs/4.x/api/nuxt-config#extends) property to your [`nuxt.config`](/dag_content/docs/4.x/directory-structure/nuxt-config) file.
