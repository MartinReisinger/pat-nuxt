...
You can enable page transitions to apply an automatic transition for all your [pages](/dag_content/docs/4.x/directory-structure/app/pages).
...
::note
If you are changing layouts as well as page, the page transition you set here will not run. Instead, you should set a [layout transition](/dag_content/docs/4.x/getting-started/transitions#layout-transitions).
::

To start adding transition between your pages, add the following CSS to your [`app.vue`](/dag_content/docs/4.x/directory-structure/app/app):
...
To set a different transition for a page, set the `pageTransition` key in [`definePageMeta`](/dag_content/docs/4.x/api/utils/define-page-meta) of the page:
...
You can enable layout transitions to apply an automatic transition for all your [layouts](/dag_content/docs/4.x/directory-structure/app/layouts).
...
To start adding transition between your pages and layouts, add the following CSS to your [`app.vue`](/dag_content/docs/4.x/directory-structure/app/app):
...
To apply dynamic transitions using conditional logic, you can leverage inline [middleware](/dag_content/docs/4.x/directory-structure/app/middleware) to assign a different transition name to `to.meta.pageTransition`.
...
By default, view transitions are enabled for all [pages](/dag_content/docs/4.x/directory-structure/app/pages), but you can set a different global default.
...
It is possible to override the default `viewTransition` value for a page by setting the `viewTransition` key in [`definePageMeta`](/dag_content/docs/4.x/api/utils/define-page-meta) of the page:
