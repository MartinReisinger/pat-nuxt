...
By default, Nuxt is configured to cover most use cases. The [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config) file can override or extend this default configuration.

## Nuxt Configuration

The [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config) file is located at the root of a Nuxt project and can override or extend the application's behavior.
...
These variables are exposed to the rest of your application using the [`useRuntimeConfig()`](/dag_content/docs/4.x/api/composables/use-runtime-config) composable.
...
These variables are exposed to the rest of your application using the [`useAppConfig`](/dag_content/docs/4.x/api/composables/use-app-config) composable.
...
Nuxt uses [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config) file as the single source of truth for configurations and skips reading external configuration files. During the course of building your project, you may have a need to configure those. The following table highlights common configurations and, where applicable, how they can be configured with Nuxt.

| Name                              | Config File             | How To Configure                                                          |
|-----------------------------------|-------------------------|---------------------------------------------------------------------------|
| [Nitro](https://nitro.build)      | ~~`nitro.config.ts`~~   | Use [`nitro`](/dag_content/docs/4.x/api/nuxt-config#nitro) key in `nuxt.config`       |
| [PostCSS](https://postcss.org)    | ~~`postcss.config.js`~~ | Use [`postcss`](/dag_content/docs/4.x/api/nuxt-config#postcss) key in `nuxt.config`   |
| [Vite](https://vite.dev)          | ~~`vite.config.ts`~~    | Use [`vite`](/dag_content/docs/4.x/api/nuxt-config#vite) key in `nuxt.config`         |
| [webpack](https://webpack.js.org) | ~~`webpack.config.ts`~~ | Use [`webpack`](/dag_content/docs/4.x/api/nuxt-config#webpack-1) key in `nuxt.config` |

Here is a list of other common config files:

| Name                                         | Config File           | How To Configure                                                              |
|----------------------------------------------|-----------------------|-------------------------------------------------------------------------------|
| [TypeScript](https://www.typescriptlang.org) | `tsconfig.json`       | [More Info](/dag_content/docs/4.x/directory-structure/tsconfig)                           |
