...
Next, we need to import and add it to our [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config) file:
...
If you're developing a Nuxt module and need to add Vite plugins, you should use the [`addVitePlugin`](/dag_content/docs/4.x/api/kit/builder#addviteplugin) utility:
