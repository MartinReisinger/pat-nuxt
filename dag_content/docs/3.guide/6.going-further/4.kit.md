...
Nuxt Kit provides composable utilities to make interacting with [Nuxt Hooks](/dag_content/docs/4.x/api/advanced/hooks), the [Nuxt Interface](/dag_content/docs/4.x/guide/going-further/internals#the-nuxt-interface) and developing [Nuxt modules](/dag_content/docs/4.x/guide/modules) super easy.
...
Nuxt Kit is an [esm-only package](/dag_content/docs/4.x/guide/concepts/esm) meaning that you **cannot** `require('@nuxt/kit')`. As a workaround, use dynamic import in the CommonJS context:
