...
These hooks are available for [Nuxt modules](/dag_content/docs/4.x/guide/modules) and build context.
...
App hooks can be mainly used by [Nuxt Plugins](/dag_content/docs/4.x/directory-structure/app/plugins) to hook into rendering lifecycle but could also be used in Vue composables.
...
These hooks are available for [server plugins](/dag_content/docs/4.x/directory-structure/server#server-plugins) to hook into Nitro's runtime behavior.
