...
A minimal Nuxt layer directory should contain a [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config) file to indicate it is a layer.
...
- [`app/components/*`](/dag_content/docs/4.x/directory-structure/app/components)   - Extend the default components
- [`app/composables/*`](/dag_content/docs/4.x/directory-structure/app/composables)  - Extend the default composables
- [`app/layouts/*`](/dag_content/docs/4.x/directory-structure/app/layouts)  - Extend the default layouts
- [`app/middleware/*`](/dag_content/docs/4.x/directory-structure/app/middleware)  - Extend the default middleware
- [`app/pages/*`](/dag_content/docs/4.x/directory-structure/app/pages)        - Extend the default pages
- [`app/plugins/*`](/dag_content/docs/4.x/directory-structure/app/plugins)        - Extend the default plugins
- [`app/utils/*`](/dag_content/docs/4.x/directory-structure/app/utils)   - Extend the default utils
- [`app/app.config.ts`](/dag_content/docs/4.x/directory-structure/app/app-config)  - Extend the default app config
- [`server/*`](/dag_content/docs/4.x/directory-structure/server)       - Extend the default server endpoints & middleware
- [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config)- Extend the default nuxt config
...
You can use the [`getLayerDirectories`](/dag_content/docs/4.x/api/kit/layers#getlayerdirectories) utility from Nuxt Kit to support custom multi-layer handling for your modules.
