...
Thanks to its opinionated directory structure, Nuxt can auto-import your [`app/components/`](/dag_content/docs/4.x/directory-structure/app/components), [`app/composables/`](/dag_content/docs/4.x/directory-structure/app/composables) and [`app/utils/`](/dag_content/docs/4.x/directory-structure/app/utils).
...
::note
In the docs, every function that is not explicitly imported is auto-imported by Nuxt and can be used as-is in your code. You can find a reference for auto-imported components, composables and utilities in the [API section](/dag_content/docs/4.x/api).
::

::note
In the [`server`](/dag_content/docs/4.x/directory-structure/server) directory, Nuxt auto-imports exported functions and variables from `server/utils/`.
::

::note
You can also auto-import functions exported from custom folders or third-party packages by configuring the [`imports`](/dag_content/docs/4.x/api/nuxt-config#imports) section of your `nuxt.config` file.
::

## Built-in Auto-imports

Nuxt auto-imports functions and composables to perform [data fetching](/dag_content/docs/4.x/getting-started/data-fetching), get access to the [app context](/dag_content/docs/4.x/api/composables/use-nuxt-app) and [runtime config](/dag_content/docs/4.x/guide/going-further/runtime-config), manage [state](/dag_content/docs/4.x/getting-started/state-management) or define components and plugins.
...
- `app/components/` for [Vue components](/dag_content/docs/4.x/directory-structure/app/components).
- `app/composables/` for [Vue composables](/dag_content/docs/4.x/directory-structure/app/composables).
...
This will disable auto-imports completely but it's still possible to use [explicit imports](/dag_content/docs/4.x/guide/concepts/auto-imports#explicit-imports) from `#imports`.
