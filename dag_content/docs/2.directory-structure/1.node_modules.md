...
::important
This directory should be added to your [`.gitignore`](/dag_content/docs/4.x/directory-structure/gitignore) file to avoid pushing the dependencies to your repository.
::
