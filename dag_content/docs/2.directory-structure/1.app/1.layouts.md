...
Layouts are enabled by adding [`<NuxtLayout>`](/dag_content/docs/4.x/api/components/nuxt-layout) to your [`app.vue`](/dag_content/docs/4.x/directory-structure/app/app):
...
To use a layout:
- Set a `layout` property in your page with [definePageMeta](/dag_content/docs/4.x/api/utils/define-page-meta).
...
::important
If you only have a single layout in your application, we recommend using [`app.vue`](/dag_content/docs/4.x/directory-structure/app/app) instead.
::
...
You can directly override the default layout for all pages using the `name` property of [`<NuxtLayout>`](/dag_content/docs/4.x/api/components/nuxt-layout):
...
You can also use the [`setPageLayout`](/dag_content/docs/4.x/api/utils/set-page-layout) helper to change the layout dynamically:
...
You can also pass props when changing the layout dynamically with [`setPageLayout`](/dag_content/docs/4.x/api/utils/set-page-layout):
...
::important
If you use `<NuxtLayout>` within your pages, make sure it is not the root element (or [disable layout/page transitions](/dag_content/docs/4.x/getting-started/transitions#disable-transitions)).
::
