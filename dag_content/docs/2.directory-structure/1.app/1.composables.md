...
Be aware that you have to run [`nuxt prepare`](/dag_content/docs/4.x/api/commands/prepare), [`nuxt dev`](/dag_content/docs/4.x/api/commands/dev) or [`nuxt build`](/dag_content/docs/4.x/api/commands/build) in order to let Nuxt generate the types.
...
You can access [plugin injections](/dag_content/docs/4.x/directory-structure/app/plugins#providing-helpers) from composables:
...
Nuxt only scans files at the top level of the [`app/composables/` directory](/dag_content/docs/4.x/directory-structure/app/composables), e.g.:
