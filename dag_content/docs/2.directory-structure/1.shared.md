...
You can now use [auto-imported](/dag_content/docs/4.x/directory-structure/shared) utilities in your Nuxt app and `server/` directory.
...
::tip
The way `shared/utils` and `shared/types` auto-imports work and are scanned is identical to the [`app/composables/`](/dag_content/docs/4.x/directory-structure/app/composables) and [`app/utils/`](/dag_content/docs/4.x/directory-structure/app/utils) directories.
::
