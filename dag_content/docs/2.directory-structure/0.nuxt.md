...
::important
This directory should be added to your [`.gitignore`](/dag_content/docs/4.x/directory-structure/gitignore) file to avoid pushing the dev build output to your repository.
::
...
::warning
You should not touch any files inside since the whole directory will be re-created when running [`nuxt dev`](/dag_content/docs/4.x/api/commands/dev).
::
