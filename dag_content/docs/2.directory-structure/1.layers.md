...
- [`nuxt.config.ts`](/dag_content/docs/4.x/directory-structure/nuxt-config) - Layer-specific configuration that will be merged with the main config
- [`app.config.ts`](/dag_content/docs/4.x/directory-structure/app/app-config) - Reactive application configuration
- [`app/components/`](/dag_content/docs/4.x/directory-structure/app/components) - Vue components (auto-imported)
- [`app/composables/`](/dag_content/docs/4.x/directory-structure/app/composables) - Vue composables (auto-imported)
- [`app/utils/`](/dag_content/docs/4.x/directory-structure/app/utils) - Utility functions (auto-imported)
- [`app/pages/`](/dag_content/docs/4.x/directory-structure/app/pages) - Application pages
- [`app/layouts/`](/dag_content/docs/4.x/directory-structure/app/layouts) - Application layouts
- [`app/middleware/`](/dag_content/docs/4.x/directory-structure/app/middleware) - Route middleware
- [`app/plugins/`](/dag_content/docs/4.x/directory-structure/app/plugins) - Nuxt plugins
- [`server/`](/dag_content/docs/4.x/directory-structure/server) - Server routes, middleware, and utilities
- [`shared/`](/dag_content/docs/4.x/directory-structure/shared) - Shared code between app and server
