...
::tip
If you need to remain on Nuxt 2, but want to benefit from Nuxt 3 features in Nuxt 2, you can alternatively check out [how to get started with Bridge](/dag_content/docs/4.x/bridge/overview).
::

## Next Steps

- Learn about differences in [configuration](/dag_content/docs/4.x/migration/configuration)
