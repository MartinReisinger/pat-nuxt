...
2. Through the [`useHead`](/dag_content/docs/4.x/api/composables/use-head) [composable](/dag_content/docs/4.x/getting-started/seo-meta)
3. Through [global meta components](/dag_content/docs/4.x/getting-started/seo-meta)
...
2. If you need to access the component state with `head`, you should migrate to using [`useHead`](/dag_content/docs/4.x/api/composables/use-head) . You might also consider using the built-in meta-components.
