...
The `test` command runs tests using [`@nuxt/test-utils`](/dag_content/docs/getting-started/testing). This command sets `process.env.NODE_ENV` to `test` if not already set.
