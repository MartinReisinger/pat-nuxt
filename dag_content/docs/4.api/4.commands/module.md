...
- add it to your [package.json](/dag_content/docs/4.x/directory-structure/package) file
- update your [`nuxt.config`](/dag_content/docs/4.x/directory-structure/nuxt-config) file
