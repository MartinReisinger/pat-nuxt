...
::note
This command sets `process.env.NODE_ENV` to `production`. To override, define `NODE_ENV` in a [`.env`](/dag_content/docs/4.x/directory-structure/env) file or as a command-line argument.
::
