...
::note
These functions are designed for registering your own utils, composables and Vue APIs. For pages, components and plugins, please refer to the specific sections: [Pages](/dag_content/docs/4.x/api/kit/pages), [Components](/dag_content/docs/4.x/api/kit/components), [Plugins](/dag_content/docs/4.x/api/kit/plugins).
::
...
::tip
To add imports for the Nitro server context, refer to the [`addServerImports`](/dag_content/docs/4.x/api/kit/nitro#addserverimports) function.
::
