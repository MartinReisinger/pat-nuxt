...
| `island`          | `boolean`                                                                                | `false`  | If enabled, registers components as islands. You can read more about islands in [`<NuxtIsland/>`](/dag_content/docs/4.x/api/components/nuxt-island) component description.                                                                                          |
...
| `declarationPath` | `string`                                   | `false`  | Path to component's declaration file. It is used to generate components' [type templates](/dag_content/docs/4.x/api/kit/templates#addtypetemplate); if not provided, `filePath` is used instead.                                                                    |
...
| `island`          | `boolean`                                  | `false`  | If enabled, registers component as island. You can read more about islands in [`<NuxtIsland/>`](/dag_content/docs/4.x/api/components/nuxt-island) component description.                                                                                            |
