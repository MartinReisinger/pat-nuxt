...
::note
Current implementation behaves exactly the same as [`preloadComponents`](/dag_content/docs/4.x/api/utils/preload-components) by preloading components instead of just prefetching we are working to improve this behavior.
::
