...
1. **Function Plugin**: A function that receives the [`NuxtApp`](/dag_content/docs/4.x/guide/going-further/internals#the-nuxtapp-interface) instance and can return a promise with a potential object with a [`provide`](/dag_content/docs/4.x/directory-structure/app/plugins#providing-helpers) property if you want to provide a helper on [`NuxtApp`](/dag_content/docs/4.x/guide/going-further/internals#the-nuxtapp-interface) instance.
