...
::note
Route middleware are navigation guards stored in the [`app/middleware/`](/dag_content/docs/4.x/directory-structure/app/middleware) directory of your Nuxt application (unless [set otherwise](/dag_content/docs/4.x/api/nuxt-config#middleware)).
::
...
Learn more about available properties of [route objects](/dag_content/docs/4.x/api/composables/use-route).
