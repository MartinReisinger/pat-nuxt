...
`definePageMeta` is a compiler macro that you can use to set metadata for your **page** components located in the [`app/pages/`](/dag_content/docs/4.x/directory-structure/app/pages) directory (unless [set otherwise](/dag_content/docs/4.x/api/nuxt-config#pages)). This way you can set custom metadata for each static or dynamic route of your Nuxt application.
...
- **Type**: `PageMeta`
  ...
  **`name`**
  ...
  - **Type**: `string`
    ...
    You may define a name for this page's route. By default, name is generated based on path inside the [`app/pages/` directory](/dag_content/docs/4.x/directory-structure/app/pages).

  **`path`**

  - **Type**: `string`

    You may define a [custom regular expression](/dag_content/docs/4.x/api/utils/define-page-meta#using-a-custom-regular-expression) if you have a more complex pattern than can be expressed with the file name.
  ...
  **`groups`**
  ...
  - **Type**: `string[]`
    ...
    Route groups the page belongs to, based on the folder structure. Automatically populated for pages within [route groups](/dag_content/docs/4.x/guide/directory-structure/app/pages#route-groups).
  ...
  **`middleware`**
  ...
  - **Type**: `MiddlewareKey` | [`NavigationGuard`](https://router.vuejs.org/api/interfaces/navigationguard) | `Array<MiddlewareKey | NavigationGuard>`
    ...
    Define anonymous or named middleware directly within `definePageMeta`. Learn more about [route middleware](/dag_content/docs/4.x/directory-structure/app/middleware).
  ...
  **`viewTransition`**
  ...
  - **Type**: `boolean | 'always' | ViewTransitionPageOptions`
    ...
    **Experimental feature, only available when [enabled in your nuxt.config file](/dag_content/docs/4.x/getting-started/transitions#view-transitions-api-experimental)**</br>
    ...
    You can also pass a `ViewTransitionPageOptions` object to configure [view transition types](/dag_content/docs/4.x/getting-started/transitions#view-transition-types):
...
You can define the layout that matches the layout's file name located (by default) in the [`app/layouts/` directory](/dag_content/docs/4.x/directory-structure/app/layouts). You can also disable the layout by setting the `layout` to `false`:
