...
::important
`setPageLayout` allows you to dynamically change the layout of a page. It relies on access to the Nuxt context and therefore can only be called within the [Nuxt context](/dag_content/docs/4.x/guide/going-further/nuxt-app#the-nuxt-context).
::
