...
::warning
Note that `callOnce` doesn't return anything. You should use [`useAsyncData`](/dag_content/docs/4.x/api/composables/use-async-data) or [`useFetch`](/dag_content/docs/4.x/api/composables/use-fetch) if you want to do data fetching during SSR.
::
