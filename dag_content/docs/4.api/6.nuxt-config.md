...
This only has an effect when **experimental** support for View Transitions is [enabled in your nuxt.config file](/dag_content/docs/4.x/getting-started/transitions#view-transitions-api-experimental).
