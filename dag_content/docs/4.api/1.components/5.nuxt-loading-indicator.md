...
Add `<NuxtLoadingIndicator/>` in your [`app.vue`](/dag_content/docs/4.x/directory-structure/app/app) or [`app/layouts/`](/dag_content/docs/4.x/directory-structure/app/layouts).
...
::note
You can hook into the underlying indicator instance using [the `useLoadingIndicator` composable](/dag_content/docs/4.x/api/composables/use-loading-indicator), which will allow you to trigger start/finish events yourself.
::
