...
- `prefetch`: When enabled will prefetch middleware, layouts and payloads (when using [payloadExtraction](/dag_content/docs/4.x/guide/going-further/experimental-features#payloadextraction)) of links in the viewport. Used by the experimental [crossOriginPrefetch](/dag_content/docs/4.x/guide/going-further/experimental-features#crossoriginprefetch) config.
...
::tip
Defaults can be overwritten, see [overwriting defaults](/dag_content/docs/4.x/api/components/nuxt-link#overwriting-defaults) if you want to change them.
::
...
You can overwrite some `<NuxtLink>` defaults in your [`nuxt.config`](/dag_content/docs/4.x/guide/going-further/experimental-features#defaults)
