...
You can use built-in [`useRequestHeaders`](/dag_content/docs/4.x/api/composables/use-request-headers) composable to access the incoming request headers within your pages, components, and plugins.
