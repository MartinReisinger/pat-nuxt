...
You can use the built-in [`useResponseHeader`](/dag_content/docs/4.x/api/composables/use-response-header) composable to set any server response header within your pages, components, and plugins.
...
We can use `useResponseHeader` for example in Nuxt [middleware](/dag_content/docs/4.x/directory-structure/app/middleware) to set a response header for all pages.
