...
In the following example, we call an API via [`useFetch`](/dag_content/docs/4.x/api/composables/use-fetch) using a dynamic page parameter - `slug` - as part of the URL.
