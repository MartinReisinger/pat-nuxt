...
A composable which returns the loading state of the page. Used by [`<NuxtLoadingIndicator>`](/dag_content/docs/4.x/api/components/nuxt-loading-indicator) and controllable.
It hooks into [`page:loading:start`](/dag_content/docs/4.x/api/advanced/hooks#app-hooks-runtime) and [`page:loading:end`](/dag_content/docs/4.x/api/advanced/hooks#app-hooks-runtime) to change its state.
