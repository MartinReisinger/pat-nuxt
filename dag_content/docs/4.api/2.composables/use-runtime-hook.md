...
- `name`: The name of the runtime hook to register. You can see the full list of [runtime Nuxt hooks here](/dag_content/docs/4.x/api/advanced/hooks#app-hooks-runtime).
