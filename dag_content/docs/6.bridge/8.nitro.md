...
Nuxt 3 introduced the new Nuxt CLI command [`nuxi`](/dag_content/docs/4.x/api/commands/add). Update your scripts as follows to leverage the better support from Nuxt Bridge:
