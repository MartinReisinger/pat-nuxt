...
For modern Nuxt projects, we recommend using [TypeScript project references](/dag_content/docs/4.x/directory-structure/tsconfig) instead of directly extending `.nuxt/tsconfig.json`.
::
